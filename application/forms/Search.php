...
class Application_Form_Search extends Zend_Form
{
    ...
    public function init()
    {
		...
		$searchtxt = new Zend_Form_Element_Text('text');
		$searchtxt->setLabel('Enter text to search :')
				 ->setRequired()
				 ->setAttrib('size', '30')
		...
		$this->addElement('image', 'searchpkg', array(
				'description' => '<a href="" class="button form_submit"><small class="icon play"></small><span>Search</span></a>',
				'ignore' => true,
				'decorators' => array(
